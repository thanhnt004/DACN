...
export default function EmailVerificationRequired() {
    ...
    // Tự động gửi email khi trang được mở lần đầu
    useEffect(() => {
        if (!initialSendDone && user?.email) {
            ...
            <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
                <div className="text-center mb-6">
                    ...
                    <p className="text-gray-600">
                        Tài khoản của bạn cần được xác thực email để tiếp tục sử dụng.
                    </p>
                    {user?.email && (
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                    <p className="text-sm text-blue-800">
                        <strong>Lưu ý:</strong> Chúng tôi đã gửi email xác thực đến địa chỉ email của bạn khi đăng ký.
                        Vui lòng kiểm tra hộp thư (kể cả thư mục spam) và nhấp vào liên kết để xác thực.
                    </p>
                </div>
