...
import { SiGoogle, SiZalo } from 'react-icons/si'
...
export default function Login() {
    ...
    return (
        <div className="w-full min-h-screen flex bg-white">
                <div className="hidden md:flex w-1/2 items-center justify-center p-12 bg-gray-50">
                    <img src="frontend/src/assets/img/logo.svg" alt="logo" className="w-2/3" />
                </div>
                ...
                <div className="w-full md:w-1/2 p-8 md:p-12">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
                        ...
                        <button
                            type="submit" 
                            className="w-full p-3  text-black rounded-md mt-2 font-semibold disabled:bg-red-400"
                            disabled={loading}
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center justify-center gap-2 p-3 border border-gray-300 rounded-md hover:bg-gray-50 cursor-pointer">
                        ...
                        {/* Zalo */}
                        <div className="flex items-center justify-center gap-2 p-3 border border-gray-300 rounded-md hover:bg-gray-50 cursor-pointer">
                            <SiZalo className="text-blue-600 text-xl" /> {/* Icon Zalo ví dụ */}
